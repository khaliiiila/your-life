        ...
        <div className="chart-container">
          <ResponsiveContainer width="100%" height={280}>
            <BarChart data={chartData}>
              ...
              <RechartsTooltip formatter={(v: any) => [idr.format(v), v]} labelFormatter={(l: React.ReactNode, payload: any) => { if (!payload || !payload[0]) return ""; const dateStr = payload[0].payload.date; return formatDateFull(new Date(`${dateStr}T00:00:00`)); }}/>
