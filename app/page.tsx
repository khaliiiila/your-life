  ...
  return <BalanceVisibility>
    ...
    <main className="main" id="main-content">
      ...
      <div className="content">
        ...
        <Card className="wide-card balance-chart" id="balance-history"><BalanceAreaChart points={getBalanceHistory(366)} /></Card>
